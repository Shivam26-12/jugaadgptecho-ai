"""
===================================================================
 ECHOSCOPE - Main AI Brain Software (v3.30 - Sensitivity Fix)
===================================================================
This script is the complete "brain" for your project.

BUG FIXES (v3.30):
- SENSITIVITY: ACTUALLY ADDED the 'sensitivities=[0.9]'
  parameter to the 'pvporcupine.create()' call (line 590).
  The previous version was missing this line.
        ...
        with sr.Microphone(device_index=WORKING_MIC_ID) as source: # Use ID 18
            ...
            try:
                ...
                # --- Command 2: "Read This" ---
                    ...
                    say("Scanning for text...", priority='high') # Low priority is fine here
...
def main():
    ...
    try:
        ...
        porcupine = pvporcupine.create(
            ...
            sensitivities=[0.9] # <-- FIX v3.30: Set to 0.9
        )
        print("Porcupine wake word engine loaded for 'Vision' (Sensitivity: 0.9).") 
